...
const WomenTops = () => {
    ...
    const renderTypeOptions = () => {
        const types = ['Kemeja', 'Bluse', 'Jaket', 'Jeans'];
        return (
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.filterContainer}>
                ...
                <TouchableOpacity style={styles.sortButton} onPress={() => setShowOptions(!showOptions)}>
                    <Image source={require('./assets/gambar/sort.webp')} style={styles.sortIcon} />
                    <Text style={styles.sortText}>Sort</Text>
                </TouchableOpacity>
            </View>

            {showOptions && renderTypeOptions()}
